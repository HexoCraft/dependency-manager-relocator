...
class UrlClassLoaderTest {
    ...
    static void init() throws IOException {
        ...
        repositories = new LinkedList<>(Collections.singletonList(new Repository(new URL("https://repo1.maven.org/maven2/")).name("Maven Central")));
    }

    @AfterAll
    static void end() {
        Assertions.assertThrows(IOException.class, () -> Downloader.deleteDir(tmpDir));
    }
